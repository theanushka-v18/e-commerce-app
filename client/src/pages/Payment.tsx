...
const Payment = () => {
    ...
    async function handlePayment() {
        // Payment logic here
        try {
          const response = await axios.put(`https://e-commerce-app-murex-one.vercel.app/auth/payment`, {
          ...
          if (response.status === 200) {
            ...
            // create an order
            const orderResponse = await axios.post('https://e-commerce-app-murex-one.vercel.app/products/createOrder', {
            ...
            await axios.put(`https://e-commerce-app-murex-one.vercel.app/products/updateOrderHistory`, {
              userId: localStorage.getItem("id"),
              orderId: orderResponse.data._id
          });

          await axios.delete('https://e-commerce-app-murex-one.vercel.app/products/deleteAllCartItems', {
            params: {
              userId: localStorage.getItem("id")
            }
          });
