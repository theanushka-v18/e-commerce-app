...
const Payment = () => {
    ...
    async function handlePayment() {
        // Payment logic here
        try {
          const response = await axios.put(`/auth/payment`, {
          ...
          if (response.status === 200) {
            ...
            // create an order
            const orderResponse = await axios.post('/products/createOrder', {
            ...
            await axios.put(`/products/updateOrderHistory`, {
              userId: localStorage.getItem("id"),
              orderId: orderResponse.data._id
          });

          await axios.delete('/products/deleteAllCartItems', {
            params: {
              userId: localStorage.getItem("id")
            }
          });
